...
Cart_items.load_cart_items = function () {
    return [
        ...
        {
            properties : [
                {property_name : "type",property_value : "不果",isFixed : true},
        ...
        {
            properties : [
                {property_name : "type",property_value : "电子产品",isFixed : true},
        ...
        },
        {
            properties : [
                ...
                {property_name : "tel",property_value : "0839-6767899",isFixed : false}
            ]
        },
        {
            properties : [
